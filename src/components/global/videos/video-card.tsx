    ...
    <Loader className='bg-[#171717] flex justify-center items-center border-[1px] border-[#252525] rounded-xl' state={props.processing}>
        <div className='group overflow-hidden cursor-pointer bg-[#171717] relative border-[1px] border-[#252525] flex flex-col rounded-xl'>
          <div className='absolute top-3 right-3 z-50  gap-x-3  hidden  group-hover:flex  '>
            <CardMenu currentFolderName={props.Folder?.name}
              videoId={props.id}
          ...
          <Link href={`/preview/${props.id}`} className='hover:bg-[#252525] transition duration-150 flex flex-col justify-between h-full'>
            ...
            <div className='px-5 py-3 flex flex-col gap-7-2 z-20'>
              ...
              <div className='flex gap-x-2 items-center mt-4'>
                ...
                <div>
                  <p className='capitalize text-[#9D9D9D] text-xs'>
                    {props.User?.firstname} {props.User?.lastname}
                  </p>
                  <p className='capitalize text-[#9D9D9D] text-xs flex items-center'>
              ...
              <div className='mt-4'>
                <span className='flex gap-x-1 items-center'>
                  ...
                  <p className='text-xs capitalize text-[#9d9d9d]'>{props.User?.firstname}s Workspace</p>
                </span>
              </div>
              </div>
